...
export const otpCreate  = impl.otpCreate;
export const otpRecent  = impl.otpRecent;
export const otpLatest  = impl.otpLatest;
export const otpAttempt = impl.otpAttempt;
export const otpConsume = impl.otpConsume;
export const otpPurge   = impl.otpPurge;
export const getCustomerByPhone       = impl.getCustomerByPhone;
export const upsertPhoneCustomer      = impl.upsertPhoneCustomer;
export const getCustomerOrdersByPhone = impl.getCustomerOrdersByPhone;
